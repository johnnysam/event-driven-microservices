package com.microservices.twitter.to.kafka.service.helper;
...
public class TwitterV2StreamHelper {
    ...
    public void connectStream(String bearerToken) throws IOException, URISyntaxException, JSONException {
        ...
        var uriBuilder = new URIBuilder(config.getTwitterV2BaseUrl());
    ...
    private void readStream(CloseableHttpResponse response) throws IOException {
    ...
    private void createRules(String bearerToken, Map<String, String> rules) throws URISyntaxException, IOException {
        ...
        URIBuilder uriBuilder = new URIBuilder(config.getTwitterV2RulesBaseUrl());
